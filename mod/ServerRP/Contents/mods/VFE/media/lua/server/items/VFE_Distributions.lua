...
table.insert(ProceduralDistributions.list.GunStoreCounter.items, "Base.AK47");
...
table.insert(ProceduralDistributions.list.GunStoreDisplayCase.items, "Base.223Clip");
table.insert(ProceduralDistributions.list.GunStoreDisplayCase.items, 5);
...
table.insert(ProceduralDistributions.list.GunStoreShelf.items, 1.8);

table.insert(ProceduralDistributions.list.GunStoreShelf.items, "Base.223Clip");
table.insert(ProceduralDistributions.list.GunStoreShelf.items, 8.5);
...
table.insert(ProceduralDistributions.list.ArmyStorageGuns.items, 4.5);
